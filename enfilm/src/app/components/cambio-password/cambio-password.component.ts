...
export class CambioPasswordComponent implements OnInit {
  ...
  actualizarPassword() {
    ...
    this.userService.ratificaPasswordUsuarioAutenticado(actualEncriptada).subscribe(resultado => {
      ...
      if (resultado["result"] == 'fail') { // El servicio responde con un fallo al comprobar la contraseña
        ...
        this.userService.cambiaPasswordUsuarioAutenticado(nuevaEncriptada).subscribe(resultado => {
